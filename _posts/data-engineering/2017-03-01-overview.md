...
To build these materialized views we needed an architecture that would enable us to perform the following easily.
...
* Persistent Append only Journal for Event Source Journal (Kafka)
